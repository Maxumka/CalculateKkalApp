...
class FragmentMaintainingViewModel(val app: Application) : AndroidViewModel(app) {
    ...
    fun calculatedCalorie() {
        ...
        DatabaseBLogic().addHistoryRecordToDatabase(context, mCalorie.value!!, "Maintaining")
    }
}